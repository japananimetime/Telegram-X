...
| [[B2 - Long press on quote text crashes]] | #951 | Interface | root-caused from crash logs 2026-09-17 (media-caption long-press recursion), fixed c313d6886, awaiting device test |
...
| [[B8 - Forwarded channel media shows no channel name]] | #950 | Interface | fixed 5ad39af9d (name gets priority, counters move to time pill), awaiting device test |
